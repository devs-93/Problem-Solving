...
class SLinkedList:
    ...
    def reverse(self):
        ...
        while current_node is not None:
            next_to_current_node = current_node.next
            current_node.next=prev_node
            prev_node=current_node
            current_node=next_to_current_node
        self.head=prev_node
...
# print("#################################################################")
# print('LinkedList Reversal is in progress...')
# print("#################################################################")
print("Linked list before calling Reverse ")
l.printLinkedList()
print("\nLinked list after calling Reverse")
l.reverse()
l.printLinkedList()
